...
A digital card game. This project is a card game that allows players to draft a deck type, fight opponets, build cards, and win. A quick demo is at the bottom of the page.
